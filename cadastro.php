...
if(isset($_POST['submit'])){
  ...
  //$result = mysqli_query($conexao, "INSERT INTO usuarios(nome, datanasc, email, senha) VALUES('$nome', '$datanasc', '$email', '$senha')");
  ...
  <body class="login-body">
    ...
    <main>
        ...
        <input type="date" name="datanasc" id="data" placeholder="Nascimento" required>
          ...
          <input type="password" name="password" id="password" placeholder="Confirme a senha" required>
